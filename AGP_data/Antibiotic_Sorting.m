...
uniqueAntibiotics = {'alvelox';'amixicylin';'amoxi';'ampi';'aug';'azr';'bac';'bes';'cefa';'cefd';'ceft';'cephad';'cephal';'cephl';'cipro';'clarithro';'clavulanate';'chlorhexidine';'clinda';'clynda';'co-trimoxazole';'cycla';'doxy';'ery';'eth';'fla';'flucl';'fluco';'iverm';'gluconate';'kef';'lansop';'levaflo';'levoflox';'levaq';'levoq';'macrob';'metronid';'metro gel';'microfura';'minocy';'moxiflox';'muciprin';'neomycin';'nitrofur';'norfloxa';'omnicef';'omoxic';'oregano';'paro';'penic';'rimadyl';'rifamp';'rifaximin';'rivaximin';'rocephin';'secniz';'septra';'smz';'solodyn';'sul';'tetra';'tinidazole';'tindamax';'vancomycin';'vigamox';'xifax';'zit';'zyt';'zocin';'zosyn';'z pac';'z-pac';'zpac'};

% Antibiotic categories:
% Inhibit peptidoglycan synthesis
type1 = 'amixicylin,amoxicillin,ampicillin,augmentin,cefadroxil,cefdinir,ceftin,cefuroxime,cephalexin,cephl,clavulanate,flucloxacillin,kef,lansopraz,omnicef,omoxicillin,penic,rocephin,vancomycin,zocin,zosyn';
% Inhibit protein synthesis
type2 = 'azr,clarithromycin,clinda,clynda,cyclamine,doxy,ery,eth,ivermectin,lansopraz,minocylin,muciprin,neomycin,paromomycin,solodyn,tetra,zit,zyt,zocin,zosyn,z pack,z-pac,zpac';
% Inhibit DNA gyrase
        ...
        for k = 3:5
            if ~isempty(matchesIndices{j})
                if ~isempty(category{1}) || ~isempty(category{2}) || ~isempty(category{3})
                    ...
                    % maybe store those that don't fall into a category
